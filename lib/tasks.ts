...
export const TASKS_BY_PROFILE: Record<Profile, Task[]> = {
  ...
  consultant: [
    { id: 'co_content', emoji: '🎬', nameEs: 'Crear contenido para redes, cursos y programas', nameEn: 'Create content for social, courses & programs', hoursPerWeek: 4 },
    { id: 'co_emails', emoji: '📧', nameEs: 'Redactar secuencias de email marketing', nameEn: 'Write email marketing sequences', hoursPerWeek: 3 },
    { id: 'co_workshops', emoji: '🎯', nameEs: 'Diseñar materiales y dinámicas para talleres', nameEn: 'Design workshop materials & dynamics', hoursPerWeek: 3 },
    { id: 'co_followup', emoji: '✅', nameEs: 'Dar seguimiento a alumnos y clientes', nameEn: 'Follow up with students & clients', hoursPerWeek: 2 },
    { id: 'co_leadmagnets', emoji: '🧲', nameEs: 'Crear lead magnets y recursos gratuitos', nameEn: 'Create lead magnets & free resources', hoursPerWeek: 3 },
    { id: 'co_webinar', emoji: '💻', nameEs: 'Escribir guiones para webinars y videos', nameEn: 'Write webinar & video scripts', hoursPerWeek: 3 },
    { id: 'co_community', emoji: '👥', nameEs: 'Gestionar comunidad de alumnos activos', nameEn: 'Manage active student community', hoursPerWeek: 2 },
    { id: 'co_ads', emoji: '📣', nameEs: 'Redactar anuncios de alta conversión (FB/IG)', nameEn: 'Write high-conversion ads (FB/IG)', hoursPerWeek: 3 },
    { id: 'co_coaching', emoji: '❓', nameEs: 'Preparar preguntas poderosas por sesión de coaching', nameEn: 'Prepare powerful coaching questions per session', hoursPerWeek: 2 },
