...
export const translations = {
  es: {
    ...
    customProfessionLabel: 'Profesión:',
    customProfessionPlaceholder: 'Ej. Diseñador de interiores, agente de seguros...',
    customTasksLabel: '¿Qué tareas son las que más tiempo te quitan a la semana?',
    customTasksPlaceholder: 'Ej. Responder los mismos correos de clientes, armar reportes, buscar información dispersa...',
    customLostHoursLabel: '¿Cuántas horas a la semana le dedicas aprox.?',
    contactNameLabel: 'Nombre',
    contactNamePlaceholder: 'Tu nombre',
    contactWhatsappLabel: 'WhatsApp',
    contactWhatsappPlaceholder: 'Ej. 81 1234 5678',
    contactEmailLabel: 'Correo (opcional)',
    contactEmailPlaceholder: 'tu@correo.com',
    contactSubmit: 'Enviar mi diagnóstico',
    contactSending: 'Enviando…',
    contactSuccess: 'Listo. Te contactamos por WhatsApp.',
    contactError: 'No se pudo enviar. Intenta de nuevo.',
    contactTitle: 'Te armamos un plan a medida',
    contactSubtitle: 'Déjanos tu WhatsApp y te escribimos con un sistema para tu profesión.',
    enterpriseCompanyLabel: 'Nombre de empresa',
    enterpriseCompanyPlaceholder: 'Ej. Estudio Norte',
    enterpriseEmailLabel: 'Correo',
    enterpriseEmailPlaceholder: 'tu@empresa.com',
    enterpriseTeamLabel: 'Tamaño del equipo',
    enterpriseAreasLabel: 'Áreas que necesitan IA',
    enterpriseAreasPlaceholder: 'Ej. Ventas, operaciones, finanzas...',
    enterpriseGoalLabel: 'Objetivo principal',
    enterpriseGoalPlaceholder: 'Ej. Estandarizar IA en todos los equipos en 90 días',
    enterpriseSubmit: 'Enviar',
    enterpriseSuccess: 'Listo. Te contactamos para armar tu cotización.',
  ...
  en: {
    ...
    customProfessionLabel: 'Profession:',
    customProfessionPlaceholder: 'E.g. Interior designer, insurance agent...',
    customTasksLabel: 'Which tasks take up the most time in your week?',
    customTasksPlaceholder: 'E.g. Answering the same client emails, putting reports together, searching scattered information...',
    customLostHoursLabel: 'About how many hours a week do you spend on this?',
    contactNameLabel: 'Name',
    contactNamePlaceholder: 'Your name',
    contactWhatsappLabel: 'WhatsApp',
    contactWhatsappPlaceholder: 'E.g. 81 1234 5678',
    contactEmailLabel: 'Email (optional)',
    contactEmailPlaceholder: 'you@email.com',
    contactSubmit: 'Send my diagnostic',
    contactSending: 'Sending…',
    contactSuccess: 'Done. We’ll contact you on WhatsApp.',
    contactError: 'Could not send. Please try again.',
    contactTitle: 'We’ll build a custom plan for you',
    contactSubtitle: 'Leave your WhatsApp and we’ll write you with a system for your profession.',
    enterpriseCompanyLabel: 'Company name',
    enterpriseCompanyPlaceholder: 'E.g. North Studio',
    enterpriseEmailLabel: 'Email',
    enterpriseEmailPlaceholder: 'you@company.com',
    enterpriseTeamLabel: 'Team size',
    enterpriseAreasLabel: 'Departments that need AI',
    enterpriseAreasPlaceholder: 'E.g. Sales, operations, finance...',
    enterpriseGoalLabel: 'Main goal',
    enterpriseGoalPlaceholder: 'E.g. Standardize AI across teams in 90 days',
    enterpriseSubmit: 'Send',
    enterpriseSuccess: 'Done. We’ll contact you to put together your quote.',
