...
export const translations = {
  es: {
    ...
    customTasksLabel: '¿Qué haces hoy de forma manual que más tiempo te quita?',
    customTasksPlaceholder: 'Ej. Responder los mismos correos de clientes, armar reportes, buscar información dispersa...',
    customLostHoursLabel: '¿Cuántas horas a la semana le dedicas aproximadamente a esas tareas?',
  ...
  en: {
    ...
    customTasksLabel: 'What do you do manually today that takes the most time?',
    customTasksPlaceholder: 'E.g. Answering the same client emails, putting reports together, searching scattered information...',
    customLostHoursLabel: 'About how many hours a week do you spend on those tasks?',
